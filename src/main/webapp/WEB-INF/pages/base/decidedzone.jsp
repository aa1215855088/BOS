...
<head>
    ...
    <script type="text/javascript">
        ...
        function doEdit() {
            ...
            $("input[name=staff]").combobox('select', rows[0].staff.name);
            $("#subareaGrid").combobox('select', rows[0].subArea.id);
        }
        ...
        function doDelete() {
            ...
            $.ajax({
                url: "${pageContext.request.contextPath}/base/dz/delDz",
                type: "post",
                data: {
                    ids: ids
                },
        ...
        $(function () {
            ...
            $('#grid').datagrid({
                ...
                pagination: true,
                toolbar: toolbar,
                url: "${pageContext.request.contextPath}/base/dz/findAll",
                idField: 'id',
                columns: columns,
        ...
        function doDblClickRow(rowIndex, rowData) {
            $('#association_subarea').datagrid({
                ...
                rownumbers: true,
                striped: true,
                url: "/base/subArea/findSubAreaByDzId/" + rowData.id,
                columns: columns1
            });
        ...
        $(function () {
            ...
            $("#save").click(function () {
                ...
                $.ajax({
                    url: "${pageContext.request.contextPath}/base/dz/addDz",
                    type: "post",
                    data: {
                        id: $("input[name=id]").val(),
                        name: $("input[name=name]").val(),
                        'staff.id': $("input[name=staff]").val(),
                        subAreaIds: subAreaIds.substring(0, subAreaIds.length - 1)
                    },
                    success: function (data) {
                        if (data.status == "1") {
                            alert(data.message);
        ...
        <form id="form1">
            <table class="table-edit" width="80%" align="center">
                ...
                <tr>
                    <td>选择负责人</td>
                    <td>
                        <input class="easyui-combobox" name="staff"
                               data-options="valueField:'id',textField:'name',url:'/base/staff/findAllStaff'"/>
                    </td>
                </tr>
                <tr height="300">
                    ...
                    <td>
                        <table id="subareaGrid" class="easyui-datagrid" border="false" style="width:300px;height:300px"
                               data-options="url:'/base/subArea/findAllSubArea',fitColumns:true,singleSelect:false">
                            <thead>
                            <tr>
