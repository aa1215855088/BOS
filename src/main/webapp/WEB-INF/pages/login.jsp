...
<head>
    ...
    <script type="text/javascript">
        ...
        function flushVerifyCode() {
            document.getElementById('loginform:vCode').src = '${pageContext.request.contextPath }/getVerifyCodeImage?' + Math.random();
        }
    </script>
</head>
<body>
            ...
            <form id="loginform" name="loginform" method="post" class="niceform"
                ...
                <div class="loginFormIpt loginFormIptWiotTh"
                    ...
                    <div id="codeInputLine" class="loginFormIpt showPlaceholder"
                        ...
                        <img id="loginform:vCode" style="position: absolute; left: -10px"
                             src="${pageContext.request.contextPath }/getVerifyCodeImage"
                             onclick="flushVerifyCode()"/>
                    </div>
                    <a href="#" onclick="login()" id="loginform:j_id19"
...
<div
    ...
    <span style="color: #488ED5;">Powered By www.hnguigu.cn</span><span
